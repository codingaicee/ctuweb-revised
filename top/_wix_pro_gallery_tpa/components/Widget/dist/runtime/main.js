...
export function getProcessedCss(styles, options, defaults) {
  ...
  var processedCssConfig = __assign(__assign({ defaults: defaults }, injectedData), { compilationHash: '__789632__' });
...
export function getStaticCss(options) {
  ...
  var cssConfig = __assign(__assign({}, injectedData), { compilationHash: '__789632__' });
