...
export const getAriaAttributes = ({ pressed, expanded, haspopup, label, live, relevant, current, owns, controls, roleDescription, hidden, disabled, describedBy, labelledBy, errorMessage, atomic, role, busy, ...ariaProps } = {}) => {
